...
- Dynamic role-category filters derived from the user's targets.
...
- Show total verified employers, total matched role directions, high-match count, latest verification date, and daily inspection time.
